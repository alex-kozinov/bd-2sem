...
def changeSurname(cursor, person):
    print('Ваша текущая Фамилия: "{}". Вы точно хотите её изменить?(y/n)'.format(person.surname))
    c = input()
    while not (c in ["y", "n"]):
        c = input()
...
def changeMidname(cursor, person):
    print('Ваше текущее Отчество: "{}". Вы точно хотите его изменить?(y/n)'.format(person.midname))
    c = input()
    while not (c in ["y", "n"]):
        c = input()
...
def changeCity(cursor, person):
    print('Город, который вы указали: "{}". Вы точно хотите его изменить?(y/n)'.format(person.city))
    c = input()
    while not (c in ["y", "n"]):
        c = input()
